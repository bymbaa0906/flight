(function (root, factory) {
    ...
    function Sparkline(element, options) {
      ...
      this.options = extend({}, Sparkline.options, options || {});
    ...
    Sparkline.prototype.initCanvas = function() {
    ...
    Sparkline.prototype.setupEventListeners = function() {
    ...
    Sparkline.prototype.showTooltip = function(event) {
